      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            ...
            SizedBox(width: 90),
            Text("5999", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
  ...
  return Container(
    child: Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 1),
        Text("CCU", style: TextStyle(color: Colors.black54)),
        SizedBox(height: 20),
        Text("21:55", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
         SizedBox(height: 1),
        Text("MAA", style: TextStyle(color: Colors.black54)),
      ],
    ),
  );
}
